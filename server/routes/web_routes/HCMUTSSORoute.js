...
const router = Router();
import { adminRegister, register, deleteAccount, updateProfile, getUserProfileById, getUserProfileByEmail, getUserIdByEmail, updateAvatar, getAvatar, test} from '../../controllers/web_controllers/HCMUT_SSO.js';
